...
<nav class="navbar-inverse">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="${path}/AdminLogin1.do">课程管理</a></li>
	...
	<div class="container" style="margin-top: 20px;">
      ...
      <tbody>
          <c:forEach items="${videoResult.data}" var="course">
           <tr>  <td><input type="checkbox"  name="bookname" value="${course.id}"></td>
							<td>${course.id}</td>
							<td>${course.courseTitle}</td>
							<td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">${course.courseDesc}</td>
							<%-- <td>${course.subject_id}</td> --%>
							<td> <a type="button"  href="${path}/getCourse.do?id=${course.id}" class="btn btn-info btn-sm">
                                <span class="" aria-hidden="true"></span>
                                    编辑</a></td>
							    <td>
                               
                                <a type="button"  href="${path}/delCourse.do?id=${course.id}" class="btn btn-danger btn-sm">
                                <span class="" aria-hidden="true" ></span>
                                    删除</a>
                            </td>
                        </tr>
