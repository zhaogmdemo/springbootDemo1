...
<link href="http://localhost:8080/SSM/js/bootstrap.css" rel="stylesheet">
...
<h1>${course.id }</h1>
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal"  action="CourseAlter.action" method="post">
			...
			<div class="form-group">
				...
				<input type="hidden" name="id" value="${course.id }">
					<input class="form-control" name="course_title"value="${course.course_title }"  placeholder="课程标题" type="text">
				</div>
			</div>
			<div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">简介</label>
				<div class="col-sm-10">
					<textarea class="form-control"  value="${course.course_desc }"name="course_desc" rows="3"></textarea>
				</div>
			</div>
			<div class="form-group">
...
<![endif]-->
<script src="http://localhost:8080/SSM/js/jquery-1.js"></script>
<script src="http://localhost:8080/SSM/js/bootstrap.js"></script>
<script src="http://localhost:8080/SSM/js/confirm.js"></script>
<script src="http://localhost:8080/SSM/js/jquery.js"></script>
<script src="http://localhost:8080/SSM/js/message_cn.js"></script>
